...
class _ChannelDrawerPageState extends State<ChannelDrawerPage> {
  ...
  Widget _buildEndDrawer() {
    return Container(
      ...
      width: widget.isLandscape ? MediaQuery.of(context).size.height - 64 + MediaQuery.of(context).padding.left : MediaQuery.of(context).size.width,
                    ...
                    child: InkWell(
                      onTap: () {
                        if (_groupIndex != index) {
                          ...
                          Scrollable.ensureVisible(context, alignment: 0.5, duration: const Duration(milliseconds: 500));
