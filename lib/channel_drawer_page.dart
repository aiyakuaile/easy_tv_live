...
class _ChannelDrawerPageState extends State<ChannelDrawerPage> {
  ...
  Widget _buildEndDrawer() {
    return Material(
      ...
      child: SizedBox(
        width: widget.isLandscape?MediaQuery.of(context).size.height-64:MediaQuery.of(context).size.width,
        child: Row(children: [
          SizedBox(
            width: 80,
                          ...
                          child: Ink(
                            ...
                            child: Row(
                              children: [
                                ...
                                if(widget.channelName == name) SpinKitWave(size: 20,color: Colors.red.withOpacity(0.4))
                              ],
                            ),
                          ),
                        );
