...
<picture>
  <source
    ...
    srcset="
      https://star-history.dera.page/svg?repos=aiyakuaile/easy_tv_live&type=Date&theme=dark
    "
  />
  <source
    media="(prefers-color-scheme: light)"
    srcset="
      https://star-history.dera.page/svg?repos=aiyakuaile/easy_tv_live&type=Date
    "
  />
  <img
    alt="Star History Chart"
    src="https://star-history.dera.page/svg?repos=aiyakuaile/easy_tv_live&type=Date"
  />
</picture>
